...
import com.example.data.repository.PhonesRepositoryImp
...
object NetworkModule {
    ...
    @Singleton
    @Provides
    fun providePhonesRemoteDataSource(retrofitService: RetrofitService) = PhonesRemoteDataSource(retrofitService)


    @Singleton
    @Provides
    fun providePhonesRepository(
        remoteDataSource: PhonesRemoteDataSource,
        localDataSource: PhonesDao
    ): PhonesRepository {
        return PhonesRepositoryImp(remoteDataSource,localDataSource)
    }
